...
chao.id = "chao"
-- Parâmetros para criar a box {x referente a localização inicial da imagem= , y referente a localização inicial da imagem= , metade da largura da box= , metade da altura da box= , angulo da box= }
...
-- (após um segundo do início do jogo, vai ser executada uma função temporária que vai criar a moeda1. Dentro da moeda1, chamamos a função "novaMoeda" [script Coletavel] dentro da função novaModa temos a localização (x=math.random, y=-100), repetições (0 é infinito), "nome do timer")
