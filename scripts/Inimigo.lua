...
function Inimigo.novo (x, y)
    ...
    Runtime:addEventListener ("enterFrame", verificarDirecao) -- enterFrame vai deixar rodando o tempo inteiro enquanto o jogo estiver em execução, vai ser executado de acordo com o que foi definido.
