-- -- Incluindo funções:
-- local function detectarTap (event) -- Comando para iniciar a função local function nome da função seguido de parênteses. -- Determina que a função é de evento.
...
-- -- Adiciona um ouvinte "tap" ao objeto.
...
-----------------------------------------------------------
-- Multitoque:
-- Para utilizar o multitoque precisamos habilitar (ativar) primeiro.
