...
physics.addBody (heroi, {densidade=0.7, friction=0.3, bounce=0.2, radius=30})

local function moverHeroi (event)
    local body = event.target
    local phase = event.phase -- fase de toque
...
-- Criar um sistema de particulas para a água
local particulas = physics.newParticleSystem {
    filename= "imagens/liquidParticle.png",
    radius= 3,
    imageRadius= 5,
    gravityScale= 1.0, -- Escala de gravidade da partículas
